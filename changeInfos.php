...
<section id="bigby">
    ...
    <div class="sectionGeneralAccount">
        <section class="changePassword">
            <form class="changeInfos" action="index.html" method="post">

                <p class="control">Nom d'utilisateur
                    <input class="input is-primary" type="text" placeholder="Primary input">
                </p>

                <p class="control">Mot de passe actuel
                    <input class="input is-primary" type="text" placeholder="Primary input">
                </p>

                <p class="control">Nouveau mot de passe
                    <input class="input is-primary" type="text" placeholder="Primary input">
                </p>
        ...
        <section class="changeUsername">
            <form class="changeInfos" action="index.html" method="post">
                ...
                <p class="control">Nouveau nom d'utilisateur
                    <input class="input is-primary" type="text" placeholder="Primary input">
                </p>
